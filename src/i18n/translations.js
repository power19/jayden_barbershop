...
const TRANSLATIONS = {
  ...
  nl: {
    ...
    menu_prices:       '💰 Prijzen van Services',
  ...
  es: {
    ...
    menu_prices:       '💰 Precios de Servicios',
  ...
  fr: {
    ...
    menu_prices:       '💰 Tarifs des Services',
  ...
  pt: {
    ...
    menu_prices:       '💰 Preços dos Serviços',
